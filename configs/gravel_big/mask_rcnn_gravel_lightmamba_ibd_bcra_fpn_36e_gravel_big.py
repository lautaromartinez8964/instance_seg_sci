...
train_pipeline = [
    ...
    dict(
        ...
        boundary_root='data/gravel_big_mmdet/auxiliary_labels'),
    dict(
...
work_dir = 'work_dirs_gravel_big/mask_rcnn_gravel_lightmamba_ibd_bcra_fpn_36e_gravel_big'