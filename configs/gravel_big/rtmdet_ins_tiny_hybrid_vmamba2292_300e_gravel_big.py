...
model = dict(
    ...
    neck=dict(in_channels=[96, 384, 768], out_channels=128, num_csp_blocks=1),
    bbox_head=dict(in_channels=128, feat_channels=128))

work_dir = 'work_dirs_gravel_big/rtmdet_ins_tiny_hybrid_vmamba2292_300e_gravel_big'