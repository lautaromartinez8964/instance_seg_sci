...
CONFIG_PATH="$ROOT_DIR/configs/gravel_big/rtmdet_ins_tiny_shared_dt_fpn_v2c_120e_gravel_big.py"
WORKDIR="$ROOT_DIR/work_dirs_gravel_big/rtmdet_ins_tiny_shared_dt_fpn_v2c_120e_gravel_big"
SESSION_NAME="RTMDet-Ins Tiny Shared DT v2c 120e"
