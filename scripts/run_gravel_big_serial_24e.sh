...
SUMMARY_FILE="$ROOT_DIR/work_dirs_gravel_big/gravel_big_serial_24e_results.md"
MASTER_LOG="$ROOT_DIR/work_dirs_gravel_big/gravel_big_serial_24e_runner.log"
...
CONFIGS=(
  "configs/gravel_big/mask_rcnn_r50_fpn_24e_gravel_big.py"
  "configs/gravel_big/mask_rcnn_vmamba_official_2292_fpn_24e_gravel_big.py"
  "configs/gravel_big/mask_rcnn_rs_lightmamba_s4_global_attn_fpn_24e_gravel_big.py"
  "configs/gravel_big/mask_rcnn_rs_lightmamba_s4_global_attn_hf_fpn_24e_gravel_big.py"
)

WORKDIRS=(
  "work_dirs_gravel_big/mask_rcnn_r50_fpn_24e_gravel_big"
  "work_dirs_gravel_big/mask_rcnn_vmamba_official_2292_fpn_24e_gravel_big"
  "work_dirs_gravel_big/mask_rcnn_rs_lightmamba_s4_global_attn_fpn_24e_gravel_big"
  "work_dirs_gravel_big/mask_rcnn_rs_lightmamba_s4_global_attn_hf_fpn_24e_gravel_big"
)
...
is_training_complete() {
  local workdir="$1"
  [[ -f "$ROOT_DIR/$workdir/epoch_24.pth" ]]
}
