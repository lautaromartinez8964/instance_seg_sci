...
SUMMARY_FILE="$ROOT_DIR/work_dirs_gravel/gravel_vmamba_serial_36e_results.md"
MASTER_LOG="$ROOT_DIR/work_dirs_gravel/gravel_vmamba_serial_36e_runner.log"
...
CONFIGS=(
  "configs/gravel/mask_rcnn_vmamba_official_2292_fpn_36e_gravel_414.py"
  "configs/gravel/mask_rcnn_rs_lightmamba_s4_global_attn_fpn_36e_gravel_414.py"
  "configs/gravel/mask_rcnn_rs_lightmamba_s4_global_attn_hf_fpn_36e_gravel_414.py"
)

WORKDIRS=(
  "work_dirs_gravel/mask_rcnn_vmamba_official_2292_fpn_36e_gravel_414"
  "work_dirs_gravel/mask_rcnn_rs_lightmamba_s4_global_attn_fpn_36e_gravel_414"
  "work_dirs_gravel/mask_rcnn_rs_lightmamba_s4_global_attn_hf_fpn_36e_gravel_414"
)
...
run_test_eval() {
  ...
  if [[ "$eval_exit_code" -ne 0 ]]; then
    echo "[$(date '+%F %T')] test eval failed for $workdir: exit_code=$eval_exit_code" | tee -a "$MASTER_LOG"
  fi
